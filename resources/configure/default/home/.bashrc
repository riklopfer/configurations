...
clean () {
    DEPTH=12
    find "${@}" -regextype posix-egrep -maxdepth $DEPTH -type f -iregex ".*\.(orig|rej|bak|tmp)" -exec rm -v {} \;
    find "${@}" -regextype posix-egrep -maxdepth $DEPTH -type f -iregex ".*(~|\#)" -exec rm -v {} \;
    find "${@}" -regextype posix-egrep -maxdepth $DEPTH -type f -iregex ".*\\.validation\\..*" -exec rm -v {} \;
}
